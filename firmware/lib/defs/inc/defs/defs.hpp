...
constexpr std::array<uint, num_in_pins> keypad_in_pins = { 8, 6, 7, 5, 4 };
...
constexpr std::array<uint, num_in_pins> keypad_in_pins = { 11, 12, 10, 13, 14 };
